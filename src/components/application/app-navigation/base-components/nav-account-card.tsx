...
import { BookOpen01, ChevronSelectorVertical, LogOut01, Plus, Settings01, User01, HelpCircle } from "@untitledui/icons";
        ...
        >
            <div className="rounded-xl bg-primary ring-1 ring-secondary">
                <div className="flex flex-col gap-0.5 py-1.5">
                    ...
                    <NavAccountCardMenuItem label="Settings" icon={Settings01} href="/dashboard/settings" />
                    <NavAccountCardMenuItem label="Support" icon={HelpCircle} href="/dashboard/support" />
                </div>
                <div className="flex flex-col gap-0.5 border-t border-secondary py-1.5">
                    <div className="px-3 pt-1.5 pb-1 text-xs font-semibold text-tertiary">Appearance</div>
...
const NavAccountCardMenuItem = ({
    ...
    if (href) {
        return (
            <a href={href} className="group/item w-full cursor-pointer px-1.5 focus:outline-hidden">
                {content}
            </a>
        );
    }
    ...
    return (
        <button {...props} className={cx("group/item w-full cursor-pointer px-1.5 focus:outline-hidden", props.className)}>
            {content}
        </button>
    );
};
